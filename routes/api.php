...
use App\Http\Controllers\User\ShopifyController;
...
Route::post('/woocommerce/webhook/order', [\App\Http\Controllers\User\EcommerceConfigurationController::class, 'wooOrderWebhook']);

Route::post('/shopify/webhook/order', [ShopifyController::class, 'orderWebhook'])->name('api.shopify.webhook.order');
