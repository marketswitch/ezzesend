    ...
    <div class="container-top">
        <div class="container-top__left w-100">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    <h5 class="container-top__title">@lang('High Value Customers')</h5>
                    <p class="container-top__desc">
                        @lang('Customers with higher total spend based on your current sales data.')
                    </p>
                </div>
    ...
    <div class="dashboard-container__body">
        ...
        <div class="card border-0 shadow-sm mt-4">
            <div class="card-header bg-white border-bottom">
                <h6 class="mb-0">@lang('High Value Customers List')</h6>
            </div>
                        ...
                        <tbody>
                            @forelse($segments as $segment)
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge buyers-segment-badge bg-success">
                                            {{ $segment['segment'] }}
                                        </span>
                                    </td>
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="9" class="text-center py-4">
                                        @lang('No high value customers found')
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
