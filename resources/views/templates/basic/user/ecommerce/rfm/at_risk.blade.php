    ...
    <div class="container-top">
        <div class="container-top__left w-100">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    <h5 class="container-top__title">@lang('At Risk Customers')</h5>
                    <p class="container-top__desc">
                        @lang('Customers who have not purchased recently and may churn soon.')
                    </p>
                </div>

                <a href="{{ route('user.ecommerce.rfm.export', 'At Risk') }}" class="btn btn--dark">
    ...
    <div class="dashboard-container__body">
        ...
        <div class="card border-0 shadow-sm mt-4">
            <div class="card-header bg-white border-bottom">
                <h6 class="mb-0">@lang('At Risk Customers List')</h6>
            </div>
                            ...
                            @empty
                                <tr>
                                    <td colspan="9" class="text-center py-4">
                                        @lang('No at risk customers found')
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
