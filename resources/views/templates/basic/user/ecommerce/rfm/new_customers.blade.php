    ...
    <div class="container-top">
        <div class="container-top__left w-100">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    <h5 class="container-top__title">@lang('New Customers')</h5>
                    <p class="container-top__desc">
                        @lang('Recently acquired customers with recent purchase activity.')
                    </p>
                </div>

                {{-- Export new segment --}}
                <a href="{{ route('user.ecommerce.rfm.export', 'New') }}" class="btn btn--dark">
    ...
    <div class="dashboard-container__body">
        ...
        <div class="card border-0 shadow-sm mt-4">
            <div class="card-header bg-white border-bottom">
                <h6 class="mb-0">@lang('New Customers List')</h6>
            </div>
