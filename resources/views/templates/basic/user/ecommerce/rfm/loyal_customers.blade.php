    ...
    <div class="container-top">
        <div class="container-top__left w-100">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    <h5 class="container-top__title">@lang('Loyal Customers')</h5>
                    <p class="container-top__desc">
                        @lang('Customers who purchase regularly and have recent engagement.')
                    </p>
                </div>

                {{-- Export loyal segment --}}
                <a href="{{ route('user.ecommerce.rfm.export', 'Loyal') }}" class="btn btn--dark">
    ...
    <div class="dashboard-container__body">
        ...
        <div class="card border-0 shadow-sm mt-4">
            <div class="card-header bg-white border-bottom">
                <h6 class="mb-0">@lang('Loyal Customers List')</h6>
            </div>
